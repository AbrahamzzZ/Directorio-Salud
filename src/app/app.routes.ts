...
export const routes: Routes = [
    ...
    { path: 'profesional-register', component:  RegistroActualizacionProfesionalComponent, canMatch: [RolPermisos], title: 'Formulario de registro'},
    ...
    { path: 'profesional-list', component: MantenimientoProfesionalComponent, canActivate: [Autenticacion], canMatch: [RolPermisos], title: 'Listado de profesionales'},
    ...
    { path: 'pacientes-registro', component: RegistroActualizacionPacienteComponent, canMatch: [RolPermisos]},
    ...
    { path: 'lista-servicios', component: ListaServiciosComponent, canActivate: [Autenticacion], title: 'Paciente'},
